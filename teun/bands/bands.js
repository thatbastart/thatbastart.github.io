window.onload=function(){
    let circles=document.getElementsByClassName("bandCircle");
    for(let i=0;i<circles.length;i++){
        circles[i].style.left=5+Math.random()*40+"vw";
        circles[i].style.top=30+Math.random()*40+"vh";
    }
