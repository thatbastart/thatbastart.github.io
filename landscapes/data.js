...
let vj_treedata=[
    ...
    {   title:"Mahogany Furniture in Potsdam",
        ...
        story:[
            {
                type:"text",
                content:["In the 19th century, mahogany furniture was really popular in royal houses, such as the Sanssouci castle. While the royal furniture is stored in collections or shown in exhibitions, other mahogany items of that era are sold in antique furniture stores."]
            },
            {
                type:"source",
                content:[
    ...
    {   title:"The Shift of Forest Politics",
        ...
        story:[
            {
                type:"text",
                content:["For a long time, forests were perceived as an economical source to generate income for their owners and were managed by national laws. Since 1980, a rising awareness for ecological problems and the worldwide decreasing forest coverage through deforestation lead to a public awareness of its consequences: air pollution, the decline in biodiversity and climate change. Since then, forest politics shifted from being a national to an international political issue.",
                "The public discourse about tropical wood trade that leads to forest loss in the amazon rainforest started in the 1980s as well, with a consumer boycott of tropical wood that was called for by environmental organizations."]
            },
            {
                type:"source",
                content:[
    ...
    {   title:"Mahogany Mindshift",
        ...
        story:[
            ...
            {
                type:"text",
                content:["Therefore, the  need for protecting these species is seen for a while. Since 1992, the conservation status of mahogany was negotiated until Swietenia macrophylla was protected by CITES in 2003.", 
    ...
    {   title:"Shifted Consequences",
        ...
        story:[
            ...
            {
                type:"text",
                content:["It is difficult to assess the impact of mahogany mining on indigenous people without entering into a dialogue with each individual.",
    ...
    {   title:"Rare Resource",
        ...
        story:[
            ...
            {
                type:"text",
                content:["Mahogany grows spatially distributed in a given forest patch and often far from each other."]
            },
            {
                type:"source",
                content:[
            ...
            {
                type:"text",
                content:["Ready for a simple visualization game? Approximately 2500 trees grow per hectare in the tropical rainforest. However, on average, only a single mahogany tree grows in the same area. When cutting and salvaging one mahogany tree (red dot), you have to search and transport between 2499 other trees (black dots)."]
            },
            {
                type:"source",
                content:[
    ...
    {   title:"The Unnatural in the Natural",
        ...
        story:[
            ...
            {
                type:"text",
                content:["Many impressive promises! Here one could almost forget the surreal, almost extraterrestrial, intervention in a functioning ecosystem."]
            },
            {
                type:"source",
                content:[
    ...
    {   title:"Value Chain",
        ...
        story:[
            ...
            {
                type:"text",
                content:["Mahogany is the most valuable timber species in the Brazilian Amazon, worth up to four times the value of its nearest competitor. One cubic meter of first-quality sawn mahogany is worth about 1800 USD when it departs for America or Europe. A single large tree can produce more timber worth about 4100 USD if the wood is of high quality."]
            },
            {
                type:"subhead",
            ...
            {
                type:"text",
                content:["Smallholders and indigenous peoples who sell mahogany trees to loggers rarely receive more than US$6-24/tree. If they receive any money at all! The mateiros (loggers) who scour the forest for mahogany, chainsaw operators who cut the trees, and haul the trees out of the forest to transport them to the nearest sawmill are also poorly paid. In fact, most of the profit goes to the middlemen who finance the resale to foreign buyers."]
            },
            {
                type:"source",
                content:[
