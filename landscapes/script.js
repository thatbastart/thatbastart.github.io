...
function init() {
    ...
    class vj_treepoint{
        ...
        content(story){
            ...
            content+="<div class='vj_preview' style='width:48%;margin-right:4%;'><div class='vj_preview_image' style=\"background-image:url('vj/preview/" + this.img + "');\"></div><div class='vj_preview_text' style='font-size:15px;'>" + this.title + "</div></div>"+
                    "<div class='vj_preview' style='width:48%;'><div class='vj_preview_image' style=\"background-image:url('vj/preview/" + this.img + "');\"></div><div class='vj_preview_text' style='font-size:15px;'>" + this.title + "</div></div>";
            return content;
        }
    }
