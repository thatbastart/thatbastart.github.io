...
function init() {
    ...
    class vj_treepoint{
        ...
        content(story){
            ...
            content+="<div style='display: flex; gap:6px;'><div class='vj_preview' style='flex-basis:50%;'><div class='vj_preview_image' style=\"background-image:url('vj/preview/" + this.img + "');\"></div><div class='vj_preview_text' style='font-size:15px;>" + this.title + "</div></div>"+
                    "<div class='vj_preview'><div class='vj_preview_image' style=\"flex-basis:50%; background-image:url('vj/preview/" + this.img + "');\"></div><div class='vj_preview_text' style='font-size:15px;'>" + this.title + "</div></div></div>";
            return content;
        }
    }
